...
class QuizRules {
  ...
  /// Базовые очки за верный ответ. Для hard-вопросов база выше — сложные
  /// вопросы ценнее.
  static const int baseScore = 100;
  static const int baseScoreHard = 200;

  /// Score per correct answer. Wrong/timeout = 0.
  ///
  /// Formula from `design_handoff_rizo_quiz/README.md`: `base + secondsLeft * 10`,
  ...
  /// База зависит от сложности: easy — 100, hard — 200. Бонус за скорость общий
  /// (до +150). Диапазон: easy 100…250, hard 200…350.
  static int scoreForAnswer({
    ...
    final base = isHard ? baseScoreHard : baseScore;
    return base + (clampedMs / 1000 * 10).round();
  }
