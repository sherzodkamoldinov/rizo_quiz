...
class QuizStrings {
  ...
  static const Map<String, Map<String, String>> _all = {
    'ru': {
      ...
      'awards_prize_note': '1 балл = 1 сум',
      'currency_uzs': 'балл',
      'congrats_eyebrow': 'ПОЗДРАВЛЯЕМ',
      'congrats_title_part_1': 'Ты в',
      'congrats_title_part_2': 'призах!',
      'congrats_prize_label': 'Твой приз',
    ...
    'uz': {
      ...
      'awards_prize_note': '1 ball = 1 so‘m',
      'currency_uzs': 'ball',
      'congrats_eyebrow': 'TABRIKLAYMIZ',
      'congrats_title_part_1': 'Sen',
      'congrats_title_part_2': 'sovrindasan!',
      'congrats_prize_label': 'Sening sovring',
    ...
    'en': {
      ...
      'awards_prize_note': '1 point = 1 UZS',
      'currency_uzs': 'points',
      'congrats_eyebrow': 'CONGRATULATIONS',
      'congrats_title_part_1': 'You',
      'congrats_title_part_2': 'placed!',
      'congrats_prize_label': 'Your prize',
